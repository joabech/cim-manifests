# ADI Manifests SDK Configuration
...
```bash
sdk-manager init --list-targets
sdk-manager init --list-targets --source <path-to-repo>
```

### Initialize a workspace
```bash
sdk-manager init -t optee-qemu-v8
sdk-manager init -t optee-qemu-v8 --source <path-to-repo>
```
...
- **OP-TEE QEMU v8 Target:** Custom dependencies for OP-TEE-specific packages and tools.
- **Dummy Targets:** Shared dependencies via symlinks; good starting point for new targets.
